...
const DoctorRecommendation = () => {
  ...
  if (!state || !doctors) {
    return (
      <>
        <Navbar />
        <div className="p-10 text-center">No recommendation data available. Please go back and try again.</div>
        <Footer />
      </>
    );
  }
            ...
            <Card key={doctor.doctor_id} className="mb-4">
              <CardContent className="p-6 space-y-2">
                ...
                <div className="flex items-center gap-2 text-sm text-muted-foreground">
                  ...
                  {doctor.experience ?? doctor.years_experience ?? 0} years experience
                </div>
                ...
                <div className="flex items-center gap-2 text-sm text-muted-foreground">
                  ...
                  {doctor.clinicAddress ?? doctor.clinic_address}{doctor.city ? `, ${doctor.city}` : ''}
                </div>
